module.exports = {
    ...
    async run(client, message, args) {
      ...
      if (isNaN(amountToDelete)) return message.reply('merci de donner un nombre ! ')
      if (!args[0] || amountToDelete > 100 || amountToDelete < 5) return message.reply('Le nombre doit etre inférieur à 100 et supérieur a 5 !');
    ...
    async runInteraction(client, interaction) {
      ...
      if (amountToDelete > 100 || amountToDelete < 5) return interaction.reply('Le nombre doit etre inférieur à 100 et supérieur a 5 !')
